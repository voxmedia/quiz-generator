...
$(document).ready(function(){
  $('head').append('<link rel="stylesheet" href="stylesheets/quiz-fashion.css" type="text/css" />');
  $('head').append('<link rel="stylesheet" href="stylesheets/quiz-racked.css" type="text/css" />');
